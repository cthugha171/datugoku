...
public class StageCreate : EditorWindow
{
    ...
    static void Init()
    {
        ...
        var window = GetWindow<StageCreate>();
        window.Show();
    }
    private void OnGUI()
    {
        ...
        mapchip = (MapObjectSet)EditorGUILayout.ObjectField("マップチップセットスクオブ", mapchip, typeof(MapObjectSet), true);
    ...
    {
        mapChipObj[0] = mapchip.space;
        mapChipObj[1] = mapchip.field;
        mapChipObj[2] = mapchip.fukku;
        mapChipObj[3] = mapchip.hikkake;
        mapChipObj[4] = mapchip.wana;
        mapChipObj[5] = mapchip.dontEnter;
        mapChipObj[6] = mapchip.player;
        mapChipObj[7] = mapchip.start;
        mapChipObj[8] = mapchip.enemy;
